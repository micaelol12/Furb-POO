...
public class ApresentacaoObra {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ApresentacaoObra window = new ApresentacaoObra();
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (o == null) {
					...
					for (int i = 0; i < o.getQtdePareceres(); i++) {
						...
						s += "\n" + p.getParceirista() + " disse " + p.getConteudo() + " em " + df.format(p.getData());
					}
				}
