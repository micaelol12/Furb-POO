...
public class AlunoUniversitario extends Aluno {
	...
	public String mostra() {
		String texto = this.getNome() + "é aluno universitário do curso de " + this.getCurso() + ", ingressando por" + this.getMetodoExtenso();
		return texto;
	}
	...
	public void setFormaIngresso(char formaIngresso) {
		...
		} else throw new IllegalArgumentException("A forma de ingresso não existe");
	...
	private String getMetodoExtenso(){
		...
		case 'I':
			return "Interna";
		default:
			throw new IllegalArgumentException("A forma de ingresso não existe");
		}
	}
